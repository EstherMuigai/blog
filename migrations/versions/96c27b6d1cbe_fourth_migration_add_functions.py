"""Fourth Migration:Add functions

Revision ID: 96c27b6d1cbe
Revises: 6f40239c32b8
Create Date: 2019-05-01 23:32:28.078866
...
revision = '96c27b6d1cbe'
down_revision = '6f40239c32b8'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('cover_pic_path', sa.String(), nullable=True),
